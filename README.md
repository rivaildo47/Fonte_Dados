...
# Gráfico de NCM – Tratamento de Dados no Colab 
### Etapas realizadas
- Importação dos dados.  
- Limpeza: remoção de duplicidades, valores nulos e inconsistências.  
...
# Dados do Comex Stat em Valor FOB tratados em Bi ( Regiões escolhidas pelos alunos )
